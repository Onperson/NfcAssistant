...
import com.power.nfc.assistant.utils.MCDiffUtils;
...
public class DiffTool extends BasicActivity {
    ...
    private void runDiff() {
        ...
        if (mDump1 != null && mDump2 != null) {
            ...
            for (int sector = 0; sector < 40; sector++) {
                ...
                header.setPadding(0, NfcAssistantApplication.dpToPx(20), 0, 0);
     ...
     * {@link NfcAssistantApplication#isValidDump(String[], boolean)} and convert its format
     ...
     * @see NfcAssistantApplication#isValidDump(String[], boolean)
     * @see NfcAssistantApplication#isValidDumpErrorToast(int, android.content.Context)
     * @see NfcAssistantApplication#readFileLineByLine(File, boolean, android.content.Context)
     ...
     * {@link NfcAssistantApplication#isValidDump(String[], boolean)})
