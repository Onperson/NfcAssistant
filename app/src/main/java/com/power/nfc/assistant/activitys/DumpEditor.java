...
public class DumpEditor extends BasicActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Color caption.
        SpannableString keyA = NfcAssistantApplication.colorString(
                getString(R.string.text_keya),
                getResources().getColor(R.color.light_green));
        SpannableString keyB =  NfcAssistantApplication.colorString(
                getString(R.string.text_keyb),
                getResources().getColor(R.color.dark_green));
        SpannableString ac = NfcAssistantApplication.colorString(
                getString(R.string.text_ac),
                getResources().getColor(R.color.orange));
        SpannableString uidAndManuf = NfcAssistantApplication.colorString(
                getString(R.string.text_uid_and_manuf),
                getResources().getColor(R.color.purple));
        SpannableString vb = NfcAssistantApplication.colorString(
        ...
        SpannableString updateText = NfcAssistantApplication.colorString(
        ...
        if (getIntent().hasExtra(EXTRA_DUMP)) {
            ...
            // Set title with UID.
            if (NfcAssistantApplication.getUID() != null) {
                mUID = NfcAssistantApplication.byte2HexString(NfcAssistantApplication.getUID());
            ...
            initEditor(NfcAssistantApplication.readFileLineByLine(file, false, this));
            setIntent(null);
     ...
     * @see NfcAssistantApplication#isValidDumpErrorToast(int, Context)
     * @see #initEditor(String[])
     */
     ...
     * {@link NfcAssistantApplication#isExternalStorageWritableErrorToast(Context)},
     ...
     * @see NfcAssistantApplication#isExternalStorageWritableErrorToast(Context)
     * @see NfcAssistantApplication#checkFileExistenceAndSave(File, String[], boolean,
     * Context, IActivityThatReactsToSave)
     */
    private void saveFile(final String[] data, final String fileName,
        ...
        String targetDir = (isDump) ? NfcAssistantApplication.DUMPS_DIR : NfcAssistantApplication.KEYS_DIR;
        final File path = NfcAssistantApplication.getFileFromStorage(
                NfcAssistantApplication.HOME_DIR +  "/" + targetDir);
            ...
            .setPositiveButton(R.string.action_save,
                    (dialog, whichButton) -> {
                        if (input.getText() != null
                            ...
                            NfcAssistantApplication.checkFileExistenceAndSave(file, data,
    ...
    private void initEditor(String[] lines) {
        int err = NfcAssistantApplication.isValidDump(lines, true);
        if (err != 0) {
            NfcAssistantApplication.isValidDumpErrorToast(err, this);
    ...
    private void decodeValueBlocks() {
        ...
        for (String line : mLines) {
            if (line.startsWith("+")) {
                ...
                if (NfcAssistantApplication.isValueBlock(line)) {
                    // Header.
     ...
     * The dump will be checked and stored in the {@link NfcAssistantApplication#TMP_DIR}
    ...
    private SpannableString colorDataBlock(String data, boolean hasUID) {
        ...
        if (hasUID) {
            ...
            ret = new SpannableString(TextUtils.concat(
                    NfcAssistantApplication.colorString(data,
                            getResources().getColor(R.color.purple))));
        } else {
            if (NfcAssistantApplication.isValueBlock(data)) {
                // Value block.
                ret = NfcAssistantApplication.colorString(data,
                        getResources().getColor(R.color.yellow));
            } else {
                // Just data.
