...
public class KeyEditor extends BasicActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(
            ...
            if (keyFile.exists()) {
                String keyDump[] = NfcAssistantApplication.readFileLineByLine(keyFile,
                        true, this);
                if (keyDump == null) {
                    // Error. Exit.
                    finish();
     ...
     * {@link NfcAssistantApplication#TMP_DIR} directory. After this, a dialog will be displayed
     * in which the user can choose between apps that are willing to
     * handle the dump.
     * @see NfcAssistantApplication#TMP_DIR
    ...
    private void shareKeyFile() {
        ...
        File file = NfcAssistantApplication.getFileFromStorage(NfcAssistantApplication.HOME_DIR + "/" +
                NfcAssistantApplication.TMP_DIR + "/" + fileName);
        if (!NfcAssistantApplication.saveFile(file, mLines, false)) {
        ...
        // Share file.
        NfcAssistantApplication.shareTmpFile(this, file);
    }
     ...
     * {@link NfcAssistantApplication#checkFileExistenceAndSave(File, String[], boolean,
     * Context, IActivityThatReactsToSave)}
     * @see NfcAssistantApplication#checkFileExistenceAndSave(File, String[], boolean, Context,
    ...
    private void onSave() {
        ...
        final File path = NfcAssistantApplication.getFileFromStorage(NfcAssistantApplication.HOME_DIR + "/" +
                NfcAssistantApplication.KEYS_DIR);
            ...
            .setPositiveButton(R.string.action_ok,
                    (dialog, whichButton) -> {
                        if (input.getText() != null
                            ...
                            NfcAssistantApplication.checkFileExistenceAndSave(file, mLines,
                                    false, cont, activity);
                        } else {
