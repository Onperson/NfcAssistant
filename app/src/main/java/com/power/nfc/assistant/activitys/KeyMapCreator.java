 ...
 * retrieved by calling {@link NfcAssistantApplication#getKeyMap()}.</li>
...
public class KeyMapCreator extends BasicActivity {
    ...
    public final static String EXTRA_KEYS_DIR =
            "com.power.nfc.assistant.Activity.KEYS_DIR";
    ...
    public final static String EXTRA_SECTOR_CHOOSER =
            "com.power.nfc.assistant.Activity.SECTOR_CHOOSER";
    /**
...
//            "com.power.nfc.assistant.Activity.KEY_MAP";
    ...
    public void onStart() {
        ...
        // setting is active).
        boolean selectLastUsedKeyFiles = NfcAssistantApplication.getPreferences().getBoolean(
     ...
     * {@link NfcAssistantApplication#setKeyMap(android.util.SparseArray)}.
    ...
    public void onCreateKeyMap(View view) {
        boolean saveLastUsedKeyFiles = NfcAssistantApplication.getPreferences().getBoolean(
                Preference.SaveLastUsedKeyFiles.toString(), true);
        ...
        if (fileNames.size() > 0) {
            ...
            if (keyFiles.size() > 0) {
                ...
                NfcAssistantApplication.setKeyMapRange(mFirstSector, mLastSector);
                // Init. GUI elements.
                mProgressStatus = -1;
        ...
        new Thread(() -> {
            ...
            mHandler.post(() -> {
                ...
                if (mIsCreatingKeyMap && mProgressStatus != -1) {
                    ...
                    NfcAssistantApplication.setKeyMap(null);
                    NfcAssistantApplication.setKeyMapRange(-1, -1);
    ...
    private void keyMapCreated(MCReader reader) {
        ...
        if (reader.getKeyMap().size() == 0) {
            ...
            NfcAssistantApplication.setKeyMap(reader.getKeyMap());
