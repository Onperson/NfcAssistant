...
public class Preferences extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences pref = NfcAssistantApplication.getPreferences();
     ...
     * {@link NfcAssistantApplication#getPreferences()}).
     * @param view The View object that triggered the method
    ...
    public void onSave(View view) {
        ...
        // Save preferences.
        SharedPreferences.Editor edit = NfcAssistantApplication.getPreferences().edit();
