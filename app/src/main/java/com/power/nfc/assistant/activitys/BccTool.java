...
public class BccTool extends BasicActivity {
     ...
     * {@link NfcAssistantApplication#calcBCC(byte[])} after some input checks (is the length
     * of the given UID valid; are there only hex symbols).
     * @param view The View object that triggered the method
     * (in this case the calculate BCC button).
     * @see NfcAssistantApplication#calcBCC(byte[])
     */
    public void onCalculate(View view) {
        ...
        // Calculate the BCC.
        byte bcc = NfcAssistantApplication.calcBCC(NfcAssistantApplication.hexStringToByteArray(data));
    ...
    public void onCopyToClipboard(View view) {
        NfcAssistantApplication.copyToClipboard(mBcc.getText().toString(), this, true);
    }
